...
const BookNow = ({ date, id, email }) => {
    ...
    const getDoctorsDetails = async () => {
        try {
            const dataset = await axios.get(`https://doctorapp-backend-gont.onrender.com/getdoctoravailability`, { params: { id: id } });
    ...
    const getAlreadyBookedData = async () => {
        try {
            const dataset = await axios.get(`https://doctorapp-backend-gont.onrender.com/getalreadybookedslots`, { params: { id: id } });
            console.log(dataset);
    ...
    const bookSlot = async () => {
        ...
        try {
            ...
            await axios.post(`https://doctorapp-backend-gont.onrender.com/submitbookings`, bookingData, { headers: { 'Authorization': `${token}` } });
        } catch (error) {
            alert(error);
        }
    };
