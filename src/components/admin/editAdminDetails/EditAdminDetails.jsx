...
const EditAdminDetails = () => {
    ...
    return (
        <div className='editadmindetails'>
            <div className='editadminimage'><img className='editadminprofileimage' src={`https://doctorapp-backend-gont.onrender.com/` + adminDetails.profile_image} alt='admin'></img></div>
